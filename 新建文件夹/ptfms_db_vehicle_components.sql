...
CREATE TABLE `vehicle_components` (
  ...
  `component_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hours_used` double DEFAULT '0',
  `last_maintenance` date DEFAULT NULL,
  `maintenance_threshold` double NOT NULL,
  PRIMARY KEY (`component_id`),
  KEY `vehicle_id` (`vehicle_id`),
  CONSTRAINT `vehicle_components_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`vehicle_id`) ON DELETE CASCADE
